...
deephage_log = setup_logger(log_name="deephage_log_2")
dnabert_2_log = setup_logger(log_name="dnabert_2_origin_round_2")
# transfer_learning_dnabert_2_log = setup_logger(log_name="transfer_learning_dnabert_2_log_ablation_test_ap")
transfer_learning_dnabert_2_log = setup_logger(log_name="phabert-cnn-no-cnn-k7")
transfer_learning_dnabert_2_log_test = setup_logger(log_name="transfer_learning_dnabert_2_log_test")
