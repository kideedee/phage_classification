...
if __name__ == "__main__":
    ...
    download_batch_from_excel("train_dataset.xlsx", is_train=True, max_workers=3, batch_size=100)
    download_batch_from_excel("test_dataset.xlsx", is_train=False, max_workers=3, batch_size=100)
