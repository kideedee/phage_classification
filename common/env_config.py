...
class Config:
    ...
    TRAIN_DATA_FASTA_FILE = os.path.join(ROOT_DIR, os.getenv("TRAIN_DATA_FASTA_FILE"))
    ...
    X_TRAIN_ADASYN = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_ADASYN"))
    Y_TRAIN_ADASYN = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_ADASYN"))
    X_TRAIN_ENN = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_ENN"))
    Y_TRAIN_ENN = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_ENN"))
    X_VAL = os.path.join(ROOT_DIR, os.getenv("X_VAL"))
    Y_VAL = os.path.join(ROOT_DIR, os.getenv("Y_VAL"))

    X_TRAIN_RUS_100_400 = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_RUS_100_400"))
    Y_TRAIN_RUS_100_400 = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_RUS_100_400"))
    X_VAL_RUS_100_400 = os.path.join(ROOT_DIR, os.getenv("X_VAL_RUS_100_400"))
    Y_VAL_RUS_100_400 = os.path.join(ROOT_DIR, os.getenv("Y_VAL_RUS_100_400"))
    X_TRAIN_RUS_400_800 = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_RUS_400_800"))
    Y_TRAIN_RUS_400_800 = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_RUS_400_800"))
    X_VAL_RUS_400_800 = os.path.join(ROOT_DIR, os.getenv("X_VAL_RUS_400_800"))
    Y_VAL_RUS_400_800 = os.path.join(ROOT_DIR, os.getenv("Y_VAL_RUS_400_800"))
    X_TRAIN_RUS_800_1200 = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_RUS_800_1200"))
    Y_TRAIN_RUS_800_1200 = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_RUS_800_1200"))
    X_VAL_RUS_800_1200 = os.path.join(ROOT_DIR, os.getenv("X_VAL_RUS_800_1200"))
    Y_VAL_RUS_800_1200 = os.path.join(ROOT_DIR, os.getenv("Y_VAL_RUS_800_1200"))
    X_TRAIN_RUS_1200_1800 = os.path.join(ROOT_DIR, os.getenv("X_TRAIN_RUS_1200_1800"))
    Y_TRAIN_RUS_1200_1800 = os.path.join(ROOT_DIR, os.getenv("Y_TRAIN_RUS_1200_1800"))
    X_VAL_RUS_1200_1800 = os.path.join(ROOT_DIR, os.getenv("X_VAL_RUS_1200_1800"))
    Y_VAL_RUS_1200_1800 = os.path.join(ROOT_DIR, os.getenv("Y_VAL_RUS_1200_1800"))

    TRAIN_DNA_BERT_2_EMBEDDING = os.path.join(ROOT_DIR, os.getenv("TRAIN_DNA_BERT_2_EMBEDDING"))
    TRAIN_DNA_BERT_2_LABELS = os.path.join(ROOT_DIR, os.getenv("TRAIN_DNA_BERT_2_LABELS"))
    VAL_DNA_BERT_2_EMBEDDING = os.path.join(ROOT_DIR, os.getenv("VAL_DNA_BERT_2_EMBEDDING"))
    VAL_DNA_BERT_2_LABELS = os.path.join(ROOT_DIR, os.getenv("VAL_DNA_BERT_2_LABELS"))
